...
class FT_Processor(Processor):
    ...
    def export_topology(self, epoch):
        ...
        if target_module is not None:
            ...
            self.io.print_log(
                '[VISUALIZATION] Warning: Could not find valid "last_h". This happens if use_virtual_conn=False or forward() was not called.')
