...
class DifferentiableSparseHypergraph(nn.Module):
    ...
    Features:
    1. Gated Differentiable Binarization (via STE).
    2. Adaptive Thresholding.
    3. [Modified] Supports toggling virtual connections via use_virtual_conn.
    """
    ...
    def forward(self, x):
        ...
        # 5. Apply Mask
        # Retain raw scores where mask is 1, else prune heavily
